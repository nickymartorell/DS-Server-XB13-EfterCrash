	...
	public Calendars() {
		...
		add(lblCBSlogo);
				...
				public void buildTable() {
					String[] columnNames = {"Name", "CreatedBy", "PublicPrivate", "Active",};
					
					Object[][] data = new Object[200][200];
					
					try {
						QueryBuilder qb = new QueryBuilder();
						rs = qb.selectFrom("calendars").all().ExecuteQuery();
						
					int count = 0;
					while (rs.next()) {
						data[count][0] = rs.getString("Name");
						data[count][1] = rs.getString("CreatedBy");
						data[count][2] = rs.getBoolean("PublicPrivate");
				...
				if (DEBUG) {
					...
					btnRemove.setBorder(new CompoundBorder(new BevelBorder(BevelBorder.LOWERED, new Color(255, 255, 255), new Color(0, 0, 0), new Color(255, 255, 255), new Color(0, 0, 0)), new BevelBorder(BevelBorder.LOWERED, new Color(255, 255, 255), new Color(0, 0, 0), new Color(255, 255, 255), new Color(0, 0, 0))));
